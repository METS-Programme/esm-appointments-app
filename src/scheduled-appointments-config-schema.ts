...
export const expectedAppointmentsPanelConfigSchema = {
  title: {
    _type: Type.String,
    _description:
      "The title to display, may be a translation key or plain text",
    _default: "expected",
  },
  status: {
    _type: Type.String,
  ...
  showForPastDate: {
    _type: Type.Boolean,
    _description:
      "Whether to display this panel when viewing scheduled appointments for a past date",
    _default: false,
  },
  showForToday: {
    _type: Type.Boolean,
    _description:
      "Whether to display this panel when viewing scheduled appointments for today",
    _default: true,
  },
  showForFutureDate: {
    _type: Type.Boolean,
    _description:
      "Whether to display this panel when viewing scheduled appointments for a future date",
    _default: true,
  },
};
