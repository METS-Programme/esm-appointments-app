...
const SeeAllAppointmentsLink = () => {
  const { useBahmniAppointmentsUI: useBahmniUI, bahmniAppointmentsUiBaseUrl } =
    useConfig();
...
const AddAppointmentLink = () => {
  ...
  return useBahmniUI ? (
    <Button
      ...
      renderIcon={(props) => (
        <Add size={16} {...props} className="cds--btn__icon" />
      )}
    >
...
const ViewCalendarLink = () => {
  ...
  return useBahmniUI ? (
    <Button
      ...
      renderIcon={(props) => (
        <Calendar size={16} {...props} className="cds--btn__icon" />
      )}
    >
