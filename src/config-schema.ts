...
export const configSchema = {
  ...
  useFullViewPrivilege: {
    _type: Type.Boolean,
    _description:
      "If set to 'false', will always display the full view, disregarding any privilege",
    _default: false,
  },
  ...
  fullViewPrivilege: {
    _type: Type.String,
    _description:
      "Name of the privilege to display the full view of the Appointments dashboard widget.",
    _default: "Today's Appointments Widget: Display Full View",
  },
  bahmniAppointmentsUiBaseUrl: {
    _type: Type.String,
    _description:
      "Configurable base URL that points to the Bahmni Appointments UI",
    _default: "/appointments",
  },
  appointmentsBaseUrl: {
    _type: Type.String,
    _description:
      "Configurable alternative URL for the Appointments UI. Eg, the Bahmni Appointments UI URL",
  ...
  showServiceQueueFields: {
    _type: Type.Boolean,
    _description:
      "Whether start visit form should display service queue fields`",
    _default: false,
  },
  defaultFacilityUrl: {
    _type: Type.String,
  ...
  patientIdentifierType: {
    _type: Type.String,
    _description:
      "The name of the patient identifier type to be used for the patient identifier field",
    _default: "OpenMRS ID",
  },
  ...
  allowAllDayAppointments: {
    _type: Type.Boolean,
    _description:
      "Whether to allow scheduling of all-day appointments (vs appointments with start time and end time)",
    _default: true,
  },
};
